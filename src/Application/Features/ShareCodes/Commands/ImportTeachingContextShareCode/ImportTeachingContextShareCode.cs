...
public record ImportTeachingContextShareCodeCommand : IRequest<int>
{
    ...
    : IRequestHandler<ImportTeachingContextShareCodeCommand, int>
{
    public async Task<int> Handle(ImportTeachingContextShareCodeCommand request, CancellationToken cancellationToken)
    {
        ...
        string autoGeneratedName = $"{sourceTeachingContext.ContextName} (Copy)";
        TeachingContext newTeachingContext = sourceTeachingContext.Clone(teacherId, autoGeneratedName);
